...
const translations = {
    ...
    ru: {
        ...
        "travelEgyptianMuseum": "Das Ägyptische Museum – Entdecken Sie die Monumente Ägyptens",
        ...
        "travelPickUpCairo": "Wir holen Sie um 3:00 Uhr von Ihrem Hotel ab und fahren ca. 430 km nach Kairo (eine andere Route von Marsa Alam nach Kairo) mit einem klimatisierten Auto oder Minibus.",
        "travelShortBreakCairo": "Um 5:30 Uhr machen wir eine kurze Pause in einem Restaurant.",
        "travelArrivalCairo": "Wir werden gegen 8 Uhr in Kairo ankommen. Zuerst machen wir eine kurze Stadtrundfahrt durch das alte Kairo, damit Sie das echte Leben in Ägypten besser sehen und kennenlernen können.",
        "travelEgyptianMuseumVisit": "Dann besuchen wir das Ägyptische Museum, das die Schätze von 7000 Jahren Zivilisation beherbergt. Die Erbschaften der alten ägyptischen Kultur werden im Ägyptischen Museum in Kairo aufbewahrt, einem der wichtigsten Museen der Welt. Sie erzählen die Geschichte eines intelligenten Volkes und seiner großen Errungenschaften. Tatsächlich können Sie bereits im Garten des Museums die Ausstrahlung der wundervollen Werke und die Magie des alten Ägyptens spüren, noch bevor Sie das Gebäude betreten. Das Museum ist erfüllt von den Düften einer glorreichen Vergangenheit und in den Augen der Statuen können Sie das Licht vergangener Zeiten sehen.",
        "travelLunchCairoTour": "Als nächstes werden Sie zu Mittag essen, wo Sie lokale ägyptische Gerichte kosten werden.",
        "travelVisitGiza": "Danach fahren wir nach Gizeh, wo wir die Pyramiden des Sphinx und den Taltempel besuchen werden. Die Pyramiden sind bei weitem der eindrucksvollste Beweis für die hohe Kultur des Nils.",
        "travelReturnHurghadaCairo": "Wir kehren gegen 20:00 Uhr nach Hurghada zurück...",
        "travelReturnCairo": "Sie können sicher sein, dass Sie auf einer privaten Tour nach Kairo von Hurghada aus die Höhepunkte der historischen Stadt besucht und erkundet haben.",
        "travelReturnHotelCairo": "Wir werden gegen 15:00 Uhr unseren Rückweg nach Hurghada antreten und gegen 20:00 Uhr werden Sie zurück in Ihr Hotel gebracht.",
        "Commentbook": "Kommentare",
        ...
        "travelProgramCairoTour": "Programm einer Privaten Tagestour nach Kairo",
